...
import com.bawei.photoviewdemo.camera.CameraRollManager;
import com.bawei.photoviewdemo.camera.LoaddingView;
            ...
            public boolean onLongClick(View v) {
                if(mImageView.getDrawable() instanceof BitmapDrawable){
                    ...
                    if(file!=null&&file.length()>0){
                        CameraRollManager rollManager=new CameraRollManager(OneActivity.this, Uri.parse(file.getAbsolutePath()));
                        rollManager.execute();
                    }
                }
                return false;
